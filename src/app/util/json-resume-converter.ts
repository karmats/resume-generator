...
export function jsonResumeToResume(jsonResume: ResumeSchema): Resume {
  ...
  return {
    ...
    social: basics.profiles
      ...
      : [],
    positions: jsonResume.work
      ? jsonResume.work.map(w => {
      ...
      : [],
    educations: jsonResume.education
      ? jsonResume.education.map(e => {
